...
function mouseMove(e){
  ...
  if(isDragging){
    ...
    if(loaded){
      ...
      if(this.INTERSECTED && names.length > 0){
        var nameInx = this.INTERSECTED % names.length;
        ...
        $("#pointer").html("<span style='color:"+products[names[nameInx].n].color+"'>"+countries[names[nameInx].c].name+" exports "+products[names[nameInx].n].name+"</span>");
        // $("#pointer").html("<span style='color:"+products[names[this.INTERSECTED % names.length].n].color+"'>"+countries[names[this.INTERSECTED].c].name+" exports "+products[names[this.INTERSECTED].n].name+"</span>");
        // highLightCountry(countries[names[this.INTERSECTED].c],true);
        highLightCountry(countries[names[nameInx].c],true);
      } else {
